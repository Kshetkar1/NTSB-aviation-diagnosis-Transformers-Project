...
### Code Bases & Data Sources

1. **OpenAI Python SDK**
   https://github.com/openai/openai-python
   *LLM and embeddings API implementation*

2. **NTSB Aviation Accident Database**
   https://www.ntsb.gov/Pages/AviationQuery.aspx
   *Historical incident data source (80,000+ incidents)*

3. **Project Repository**
   https://github.com/Kshetkar1/NTSB-aviation-diagnosis-Transformers-Project
