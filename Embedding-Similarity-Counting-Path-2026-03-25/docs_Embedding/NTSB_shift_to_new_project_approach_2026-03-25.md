...
**Pre-assembled copy:** repo folder [`NTSB_new_project_bundle_2026-03-25/`](NTSB_new_project_bundle_2026-03-25/) contains code, `data/raw/`, `cursor_3/`, and this doc—see [`README_BUNDLE.md`](NTSB_new_project_bundle_2026-03-25/README_BUNDLE.md). Large `data/processed/*` artifacts are **not** inside (copy or regenerate).
