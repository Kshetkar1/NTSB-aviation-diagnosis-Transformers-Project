...
import main_app
if main_app.active_backend != selected_backend:
...
st.sidebar.caption(f"Active: **{main_app.active_backend}** | Embeddings: **{main_app.embeddings.shape if main_app.embeddings is not None else 'N/A'}**")
