...
print("="*70)
print("PRE-COMPUTING DIAGNOSTIC DATA (BOTH SOURCES)")
print("="*70)
...
from config import DATA_DIR, REFINED_DATA_PATH, EMBEDDINGS_MAP_PATH, CAUSE_STATS_PATH

with open(REFINED_DATA_PATH, 'r') as f:
    refined_data = json.load(f)
print(f"✅ Loaded {len(refined_data)} incidents from refined_dataset.json")

# Load embeddings map
with open(EMBEDDINGS_MAP_PATH, 'r') as f:
    embeddings_map = json.load(f)
print(f"✅ Loaded {len(embeddings_map)} entries from embeddings_map.json")
...
print(f"✅ Saved augmented embeddings_map.json")
...
with open(CAUSE_STATS_PATH, 'w') as f:
    json.dump(global_stats, f, indent=2)

print(f"✅ Saved global statistics to cause_statistics.json")
