...
Our system uses this same concept: embeddings from text-embedding-3-small are generated by a multi-head transformer that learned to capture diverse semantic relationships.
